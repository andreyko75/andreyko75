...
**Голос:**  
Text-to-Speech (TTS) · Speech-to-Text (STT) · OpenAI Whisper · генерация и транскрибация аудио · голосовые ассистенты и боты

**Изображения (генерация):**  
DALL·E · FusionBrain (Kandinsky) · генерация иллюстраций, визуальных концептов и фотореалистичных изображений · улучшение промптов под генерацию (в т.ч. через DeepSeek)

**Видео (генерация и обработка):**  
Kling · Runway · Sora · Luma · Pika · Gemini · монтаж и сборка роликов (MoviePy, стоковые API)
